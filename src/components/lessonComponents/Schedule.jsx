...
import { Container } from '@/components/lessonComponents/Container'
...
const schedule = [
  {
    ...
    dateTime: '2022-04-04',
    summary:
      'ATG Academy prepared number of tests to achieve high skills in work. Please select your field from section:',
    timeSlots: [
      {
        name: 'Engineer Electrics',
      ...
      {
        name: 'From Automated Engineer',
        description: 'Not so one-time payments',
        start: '9:00AM',
        end: '10:00AM',
        link: 'https://forms.gle/8a4zsQ1RbkkiQrPE9',
      },
      {
        name: 'LMS Presentation',
        description: 'The finer print',
        start: '10:00AM',
        end: '11:00AM',
        link: 'https://docs.google.com/presentation/d/10gI2qNWjm03xtQT-OkPb8fXyRvO0MmUG/edit?usp=sharing&ouid=107066339199668054292&rtpof=true&sd=true',
      },
      {
